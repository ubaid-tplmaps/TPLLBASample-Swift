...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TPLLBA",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class UILocalNotification;

SWIFT_CLASS("_TtC6TPLLBA5LBAds")
@interface LBAds : NSObject
/// Initialize and Get the instance of LBAds
+ (LBAds * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
/// \param appId App Id is mandatory.
///
- (void)initializeAdsWithAppId:(NSString * _Nonnull)appId;
...
/// }
///
/// \endcode\param accessToken Access Token is mandatory.
///
- (void)setAPNSToken:(NSString * _Nonnull)accessToken;
/// Set user information to send ads according to user
/// \param userName Name is optional.
///
/// \param dob DateOfBirth is optional.
///
/// \param gender Gender is optional.
///
- (void)setUserInfoWithName:(NSString * _Nullable)userName DateOfBirth:(NSDate * _Nullable)dob Gender:(NSString * _Nullable)gender;
...
///
///
/// \endcode\param notification Notification received from AppDelegate callback.
///
- (void)notificationTapped:(UILocalNotification * _Nonnull)notification;
@end
